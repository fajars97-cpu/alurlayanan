...
export const DOCTORS_BY_POLI = {
  ...
  konseling_psikologi: "NADIRA KHAIRUNNISA",
};
...
export const EXTRA_INFO = {
  ...
  // Konseling Psikologi
  "Konseling Psikologi": [
    "Layanan konseling psikologi klinis oleh NADIRA KHAIRUNNISA.",
    "Jadwal Senin-Kamis 08.00-12.00 dan 13.00-16.00.",
    "Jadwal Jumat 08.00-11.30 dan 13.00-16.30.",
    "Layanan buka Senin-Jumat dan tutup Sabtu-Minggu.",
  ],
  // KI Hamil
